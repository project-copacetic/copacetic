...
# Verify Sigstore attestation against the transparency log (not trusting the release page alone)
gh attestation verify trivy.deb --repo aquasecurity/trivy || echo "WARNING: attestation verification failed - verify manually"
