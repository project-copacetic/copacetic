...
| `TestDistrolessUpdatePreservesCustomDebconfConfiguration` | Stakater Reloader derivative, amd64 | Validates saved timezone answers through a custom `DEBCONF_SYSTEMRC`, package upgrades, configuration and application preservation, and rejection of Debconf state under `/var/lib/dpkg` before output |
