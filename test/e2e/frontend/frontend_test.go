...
const (
	...
	frontendNginxBaseImage = "docker.io/library/nginx:1.25.3-bookworm"
	buildCommand           = "build"
...
func TestFrontendPatch(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			localImage: "localhost:5000/nginx:1.25.3-bookworm",
		},
		{
			name:       "alpine",
		...
		},
		{
			...
			baseImage:  "docker.io/library/python:3.11.6-bookworm",
			localImage: "localhost:5000/python:3.11.6-bookworm",
...
func runFrontendMultiplatformTest(t *testing.T) {
	...
	baseImage := frontendNginxBaseImage
	localImage := "localhost:5000/nginx-multiarch:1.25.3-bookworm"
...
func runFrontendAttestationTest(t *testing.T) {
	...
	baseImage := frontendNginxBaseImage
	localImage := "localhost:5000/nginx-attestation:1.25.3-bookworm"
	patchedImage := "localhost:5000/nginx-attestation:1.25.3-bookworm-patched"
