# Using copa with container scanning reports

This sample illustrates how to [patch containers using vulnerability reports](../vulnerability-driven-patching.md) with `copa`.
...
2. Scan the container image for patchable OS vulnerabilities:
